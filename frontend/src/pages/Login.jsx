...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#080808] via-[#121212] to-[#7c2d12] flex items-center justify-center p-6">
      ...
      <div className="w-full max-w-md bg-[#111111]/95 backdrop-blur-xl border border-zinc-800 rounded-3xl shadow-2xl p-10">
        ...
        <form onSubmit={handleSubmit}>
          ...
          {error && (
            <div className="bg-red-500/10 text-red-300 border border-red-500/20 rounded-xl p-3 mb-5 text-center">
              {error}
            </div>
          )}
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-orange-500 hover:bg-orange-400 hover:scale-105 transition-all duration-300 text-white py-3 rounded-xl font-semibold shadow-lg"
          >
