...
import { getHealthAlerts } from "../services/dashboardService";
      ...
      <section className="health-alerts-container">
        ...
        <style>{`
          ...
          .health-alerts-icon {
            ...
            background:
              rgba(232,117,42,0.065);

            border:
              1px solid
              rgba(232,117,42,0.13);
    ...
    <section className="health-alerts-container">
      ...
      <style>{`
        ...
        .health-alert-icon {
          ...
          background:
            rgba(232,117,42,0.08);

          border:
            1px solid
            rgba(232,117,42,0.16);
